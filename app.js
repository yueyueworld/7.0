...
const learnPracticeToFlip = document.getElementById("learn-practice-to-flip");
const learnPracticeToCollection = document.getElementById("learn-practice-to-collection");
...
learnPracticeToFlip.addEventListener("click", () => {
  openLearningView("view-learning-flip");
  updateLearningPointsText();
});
learnPracticeToCollection.addEventListener("click", () => {
  openLearningView("view-learning-collection");
  renderCollection();
});
